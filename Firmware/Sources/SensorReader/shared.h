...
// From SDS011.h
float pub_avg_ppm_10 = 0;
float pub_avg_ppm_25 = 0;

float pub_disp_ppm_10 = 0;
float pub_disp_ppm_25 = 0;

#define NO_OF_AVERAGES 25

#include "Average.h"

Average pub_pm25Average(NO_OF_AVERAGES);
Average pub_pm10Average(NO_OF_AVERAGES);
...
boolean pub_lora_force_test = false;
